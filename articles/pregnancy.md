...
which this vignette built. That was on **January 03, 2026**, so for the
...
#> ℹ Estimated due date: Wednesday, April 01, 2026
#> ℹ Estimated birth period begins: March 11, 2026 (37 weeks)
#> ℹ Estimated birth period ends: April 15, 2026 (42 weeks)
```
...
#> ℹ That's 12 weeks and 4 days until the due date (April 01, 2026).
#> ℹ You are 69% through the pregnancy.
how_far(on_date = today + 1, due_date = due_date)
#> ℹ On January 04, 2026, you will be 27 weeks and 4 days pregnant.
```
...
#> ℹ On February 11, 2026, you will be 33 weeks pregnant.
...
#> ℹ On February 11, 2026, Ruth will be 33 weeks pregnant.
#> ℹ That's 5 weeks and 4 days away.
```
...
#> ℹ Estimated test date (urine): Sunday, January 11, 2026
#> ℹ Estimated test date (blood): Friday, January 09, 2026
```
...
#> 1 progynova  tablet           3 2025-12-20 2025-12-30
#> 2 progynova  tablet           6 2025-12-31 2026-01-10
#> 3 cyclogest  pessary          2 2026-01-02 2026-01-10
#> 4 clexane    injection        1 2026-01-07 2026-03-06
```
...
#> ℹ That's 25 weeks and 5 days until the due date (July 02, 2026).
#> ℹ You are 36% through the pregnancy.
```

``` r
date_when(20)
#> ℹ On February 12, 2026, you will be 20 weeks pregnant.
