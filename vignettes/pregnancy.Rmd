...
There is one further date-related function in the package, which is useful if you are not yet pregnant but think there's a chance you might be.
...
```{r}
calculate_test_date(as.Date("2025-08-21"))
```
