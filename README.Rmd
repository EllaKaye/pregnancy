...
[![CRAN status](https://www.r-pkg.org/badges/version/pregnancy)](https://CRAN.R-project.org/package=pregnancy)
<!-- badges: end -->
...
To easily keep this document fairly up-to-date, 
and prevent recurring package build and CRAN failures as time goes by, 
I have not hard-coded any dates. 
Instead, I have calculated everything from the date on which this README was last built. 
