...
> This R package is in the very final stages of development, with a view to release in early September 2025.
> 
...
and you will not need to use the `set_*` family of functions. 
